...
OUT_PATH=${BASE_PATH}/Preprocessing/Annotations/set_merged_roi/
IN_PATH1=${BASE_PATH}/Preprocessing/Annotations/set04/
...
python merge_xml_left_right_roi.py ${IMG_PATH} ${OUT_PATH} ${IN_PATH1}
