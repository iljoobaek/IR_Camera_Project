...
if __name__ == '__main__':
    checkpoint_path = os.path.join(dirname,
        'training/train_ssd_mobilenet_v2_FLIR_CMU00-05-selected_0907/model.ckpt-300000')
    pipeline_config_path = os.path.join(dirname,
        'training/train_ssd_mobilenet_v2_FLIR_CMU00-05-selected_0907/pipeline.config')
