...
if __name__ == '__main__':
    checkpoint_path = os.path.join(dirname,
        'training/train_ssd_mobilenet_v1_FLIR_CMU00-05-selected_all_1220_roi/model.ckpt-300000')
    pipeline_config_path = os.path.join(dirname,
        'training/train_ssd_mobilenet_v1_FLIR_CMU00-05-selected_all_1220_roi/pipeline.config')
