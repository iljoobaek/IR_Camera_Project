...
if __name__ == '__main__':
    checkpoint_path = os.path.join(dirname,
        'training/train_ssd_mobilenet_v1_FLIR_CMU00-05-selected_0813/model.ckpt-350000')
    pipeline_config_path = os.path.join(dirname,
        'training/train_ssd_mobilenet_v1_FLIR_CMU00-05-selected_0813/pipeline.config')
