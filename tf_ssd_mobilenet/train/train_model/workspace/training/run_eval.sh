...
python eval.py --eval_dir=./eval/eval_ssd_mobilenet_v1_CMU00-05-selected_different/ \
                --checkpoint_dir=./training/train_ssd_mobilenet_v1_CMU00-05-selected_different/ \
