...
python eval.py --eval_dir=./eval/eval_ssd_mobilenet_v1_CMU00-05-selected_only_car_person_1/ \
                --checkpoint_dir=./training/train_ssd_mobilenet_v1_CMU00-05-selected_only_car_person_1/ \
