...
python eval.py --eval_dir=./eval/eval_ssd_mobilenet_v1_FLIR_CMU00-05-selected_all_1219_homo/ \
                --checkpoint_dir=./training/train_ssd_mobilenet_v1_FLIR_CMU00-05-selected_all_1219_homo/ \
