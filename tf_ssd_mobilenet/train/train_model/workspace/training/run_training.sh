...
#python train.py --train_dir=./training/train_ssd_mobilenet_v1_FLIR_CMU00-05-selected_all_0825/ \
#                --pipeline_config_path=./configs/ssd_mobilenet_v1.config \

python train.py --train_dir=./training/train_ssd_mobilenet_v1_FLIR_CMU00-05-selected_all_0827_config2/ \
                --pipeline_config_path=./configs/ssd_mobilenet_v1.config \
